defmodule WaymarkFhirWeb.Live.WayMarkerLiveTest do
  ...
  describe "Browser Routes" do
    ...
    test "GET /waymarkers/:id", %{conn: conn, organization: org} do
      ...
      {:ok, waymarker} =
        WaymarkFhir.Query.create_or_update_record(%WaymarkFhir.Waymarkers.Waymarker{
  ...
  describe "LiveView Interactions" do
    ...
    test "Waymarker details show encounters", %{conn: conn, organization: org} do
      ...
      {:ok, patient} =
        WaymarkFhir.Query.create_or_update_record(%WaymarkFhir.Patients.Patient{
      ...
      {:ok, _encounter} =
        WaymarkFhir.Query.create_or_update_record(%WaymarkFhir.Encounters.Encounter{
